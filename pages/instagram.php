    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <i class="fa fa-instagram"></i> Tag Generator -> Instagram
                </li>
            </ol>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-sm-4">
            	<div class="form-group">
                    ...
                    <select name="category1" id="category1" class="form-control" onchange="category_select('1','1');">
            ...
            <div class="col-sm-4">
            	<div class="form-group">
                    ...
                    <select name="category2" id="category2" class="form-control" onchange="category_select('2','1');">
                    	<option default value="0">Select Category</option>
                    	<?php $c->categories_selector();?>
                    </select>
            ...
            <div class="col-sm-4">
            	<div class="form-group">
                    ...
                    <select name="category3" id="category3" class="form-control" onchange="category_select('3','1');">
                    	<option default value="0">Select Category</option>
                    	<?php $c->categories_selector();?>
                    </select>
